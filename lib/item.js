...
class MenuItem {
  ...
  async execCommand() {
    ...
    await lumine.commands.dispatch(target, this.command, this.commandDetail);
  }
    ...
    setTimeout(() => {
      ...
      if (command !== undefined) {
        if (MenuItem.isReopenProjectCommand(command, commandDetail)) {
          ...
          result = lumine.commands.dispatch(target, command, commandDetail);
        }
      }
  ...
  async execCommandWith(command, commandDetail, targetElement) {
    ...
    await lumine.commands.dispatch(target, command, commandDetail);
  }
